	        ...
	        <div className={style.contentWrap}>
	          ...
	          <div className={style.partners}>
	            ...
	            <div
	              className={`${style.partnerImages} ${
									data?.trusted_by?.length > 3 ? style.partnerImagesScroll : ''
								}`}
	            >
	              {data?.trusted_by?.map((image, i) => {
	                return (
	                  <ImageLoader src={image} style={style.landingImg} lazy />
	                );
	              })}
	            </div>
	          </div>
	          <div className={style.signInUpBtnWrap}>
	            <p>
	              ...
	              <a onClick={this.toggleLoginForm}>{getTranslation('SIGNIN')}</a>
	            </p>
	            <ButtonDescription
