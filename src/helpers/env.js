...
export const urlLeaderboard = `${process.env.API_DOMAIN}leaderboard/points`;
export const urlLeaderboardTask = `${process.env.API_DOMAIN}leaderboard/tasks`;
export const urlLeaderboardH2H = `${process.env.API_DOMAIN}leaderboard/h2h`;
...
export const urlCrowdsourcing = `${process.env.API_DOMAIN}community/crowdsource?/search`;
...
export const urlPinkPatrolReport = `${process.env.API_DOMAIN}user/pink-patrol`;
